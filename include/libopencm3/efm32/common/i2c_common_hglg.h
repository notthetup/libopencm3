...
/** @endcond */
#ifndef LIBOPENCM3_EFM32_I2C_COMMON_HGLG_H
#define LIBOPENCM3_EFM32_I2C_COMMON_HGLG_H
...
#define I2C_IFC_MASK          0x0001FFCFUL
...
/** @defgroup i2c_num I2C Peripheral Number
...
/** @cond */
#else
#warning "i2c_common_hglg.h should not be included explicitly, only via i2c.h"
#endif
/** @endcond */
